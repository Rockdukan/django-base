...
from core.settings import AUTHENTICATION_BACKENDS, MIDDLEWARE
...
# При регистрации пользователь обязан указать адрес электронной почты.
...
# При регистрации позвольте пользователю дважды ввести свой адрес
# электронной почты, чтобы избежать опечаток.
...
# При регистрации позвольте пользователю ввести свой пароль дважды,
...
# Пользователь должен ввести имя пользователя при регистрации.
