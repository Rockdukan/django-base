...
TINYMCE_DEFAULT_CONFIG = {
    ...
    "statusbar": True,
    "theme": "silver",
    "plugins": "advlist anchor autolink autoresize autosave"
    ...
    "toolbar2": "fontselect fontsizeselect formatselect|numlist bullist|"
    "casechange permanentpen formatpainter removeformat|"
    "pagebreak|charmap emoticons",
    "toolbar3": "fullscreen  preview save print|visualaid insertfile image media"
